...
import com.tomoka.flixster.models.Config;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        // track view objects // automatically finds each field by the specified ID
        @BindView(R.id.ivPosterImage) @Nullable ImageView ivPosterImage;
        @BindView(R.id.ivBackdropImage) @Nullable ImageView ivBackdropImage;
